...
{
    public class CR_MotoRider : Agent
    {
        private StatsRecorder m_Stats;
        private CR_MotoPhysics m_Physics;
        private UT_ResetSimHandler m_Resetter;
        private CR_PathBehavior m_Road;
        ...
        public override void Initialize()
        {
            ...
            m_Road = FindObjectOfType<CR_PathBehavior>();
            m_Resetter = new UT_ResetSimHandler(transform);
        }
