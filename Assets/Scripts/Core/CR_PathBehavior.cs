...
{
    public class CR_PathBehavior : MonoBehaviour
    {
        private int m_NumAgents;
        private IList<CR_MotoRider> m_Agents;
        ...
        {
            ReadVertexData();
            m_NumAgents = FindObjectsOfType<CR_MotoRider>().Length;
        }

        public void OnEpisodeBegin(CR_MotoRider agent)
        {
            m_Agents ??= new List<CR_MotoRider>();
            m_Agents.Add(agent);
