...
{
    /// <summary>
    /// Component that wraps a <see cref="CR_GridSensor"/>.
    /// </summary>
    public class CR_GridSensorComponentBase : SensorComponent
    {
        public CR_GridSensor Sensor { get; private set; }
        ...
        /// <summary>
        /// Name of the generated <see cref="CR_GridSensor"/>.
        /// </summary>
        ...
        public override ISensor CreateSensor()
        {
            ...
            Validate();
            Sensor = new CR_GridSensor(GetPixelGrid(), m_CompressionType, m_SensorName);
            return Sensor;
        }
